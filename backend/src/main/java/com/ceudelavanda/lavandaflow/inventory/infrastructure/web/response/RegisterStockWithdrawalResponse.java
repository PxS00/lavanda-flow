...
public record RegisterStockWithdrawalResponse(
    UUID movementId,
    UUID batchId,
    MovementType type,
    BigDecimal quantity,
    ...
    public static RegisterStockWithdrawalResponse from(StockMovementResult result) {
        return new RegisterStockWithdrawalResponse(
            result.movementId(),
            result.batchId(),
            result.type(),
            result.quantity(),
