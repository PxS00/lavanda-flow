...
public record LowStockAlertEntryResponse(
    ...
    @Schema(description = "Available non-expired quantity at asOfDate.", example = "0.000000")
    BigDecimal availableQuantity,
    @Schema(description = "Configured positive minimum quantity.", example = "250.000000")
    BigDecimal minimumQuantity,
    @Schema(description = "Minimum quantity minus available quantity.", example = "250.000000")
