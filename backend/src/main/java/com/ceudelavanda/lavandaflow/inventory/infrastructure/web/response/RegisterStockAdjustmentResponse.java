...
public record RegisterStockAdjustmentResponse(
    UUID movementId,
    UUID batchId,
    MovementType type,
    BigDecimal quantity,
    ...
    public static RegisterStockAdjustmentResponse from(StockMovementResult result) {
        return new RegisterStockAdjustmentResponse(
            result.movementId(),
            result.batchId(),
            result.type(),
            result.quantity(),
